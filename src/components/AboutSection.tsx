...
// ✅ Public folder images don’t need import — just use the path
const aboutImage = "/assets/1 (2).png";
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                With multiple sites, including our state-of-the-art combined
                cycle and high-capacity substations, we tap into and enhance the
                energy grid, supporting both industrial clients and broader
                energy markets.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                We are focused on continuously expanding our power
                infrastructure to create a resilient backbone for the future of
